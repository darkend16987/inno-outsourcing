            ...
            {method === 'email' ? (
              <>
                ...
                <div className={styles.field}>
                  ...
                  <div className={styles.inputWrap}>
                    ...
                    <input type={showPw ? 'text' : 'password'} placeholder="••••••••" className={styles.input} />
              ...
              <div className={styles.field}>
                ...
                <div className={styles.inputWrap}>
                  ...
                  <input type="tel" placeholder="0901 234 567" className={styles.input} />
                </div>
                <p className={styles.hint}>Chúng tôi sẽ gửi mã OTP đến số điện thoại này.</p>
              </div>
            )}

            <Button variant="primary" fullWidth size="lg" type="submit" iconRight={<ArrowRight size={16} />}>
              {method === 'email' ? 'Đăng nhập' : 'Gửi mã OTP'}
            </Button>
          </form>
