...
<body>
  ...
  <p class="indent"><b>Phạm vi:</b> ${contract.scope}</p>
  <p class="indent"><b>Tổng giá trị:</b> ${contract.totalValue.toLocaleString('vi-VN')}₫</p>
  <p class="indent"><b>Thanh toán:</b> ${contract.paymentTerms}</p>
  ${milestonesHtml ? `<div class="indent">${milestonesHtml}</div>` : ''}
  <div class="sig-row">
    <div class="sig-box">
